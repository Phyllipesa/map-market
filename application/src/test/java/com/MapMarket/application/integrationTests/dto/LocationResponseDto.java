...
public class LocationResponseDto extends RepresentationModel<LocationResponseDto> implements Serializable {
  ...
  private Long part;
  private Long shelf;
  private com.MapMarket.application.rest.responseDto.ProductResponseDto productResponseDto;

  public LocationResponseDto() {
  }

  public LocationResponseDto(Long id, ShelvingUnitEntity shelvingUnit, String side, Long part, Long shelf, com.MapMarket.application.rest.responseDto.ProductResponseDto productResponseDto) {
    this.key = id;
  ...
  public com.MapMarket.application.rest.responseDto.ProductResponseDto getProduct() {
